...
import { HeaderTwoColumnText } from '../../lib/main';

const meta: Meta<typeof HeaderTwoColumnText> = {
  title: 'Blocks/Headers/Header-TwoColumn-Text',
  component: HeaderTwoColumnText,
  argTypes: {
...
export default meta;
type Story = StoryObj<typeof HeaderTwoColumnText>;

...
import { HeaderGrid } from '../../lib/main';
import { allLessons } from '../data/allLessons';

const meta: Meta<typeof HeaderGrid> = {
  title: 'Blocks/Headers/Header-Grid',
...
export default meta;
type Story = StoryObj<typeof HeaderGrid>;

export const Primary: Story = {
  args: {
    headline: 'Extended Producer Responsibility (EPR)',
    sidebarHeadline: 'Latest EPR Articles',
    subheadline:
